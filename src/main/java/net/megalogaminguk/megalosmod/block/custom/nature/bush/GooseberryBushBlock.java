package net.megalogaminguk.megalosmod.block.custom.nature.bush;
...
public class GooseberryBushBlock extends SweetBerryBushBlock{
    ...
    public ItemStack getCloneItemStack(LevelReader level, BlockPos pos, BlockState state){
        return new ItemStack(ModItems.GOOSEBERRY_BERRIES.get());
    }
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult) {
        ...
        if (i > 1) {
            ...
            popResource(level, pos, new ItemStack(ModItems.GOOSEBERRY_BERRIES.get(), j + (flag ? 1 : 0)));
