package net.megalogaminguk.megalosaio.worldgen;
...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_TREE_MAPLE_SYCAMORE = registerKey("add_tree_maple_sycamore");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_TREE_MAPLE_SYCAMORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                HolderSet.direct(biomes.getOrThrow(Biomes.MEADOW)),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.MAPLE_SYCAMORE_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, name));
    }
}