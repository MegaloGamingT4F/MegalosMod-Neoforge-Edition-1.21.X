...
import net.megalogaminguk.megalosaio.item.tools.ModToolTiers;
...
public class ModItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(MegalosAIO.MOD_ID);
