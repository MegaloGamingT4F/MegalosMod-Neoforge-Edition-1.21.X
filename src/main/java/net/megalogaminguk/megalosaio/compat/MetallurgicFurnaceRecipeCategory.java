package net.megalogaminguk.megalosaio.compat;
...
import net.megalogaminguk.megalosaio.recipe.MetallurgicFurnaceRecipe;
...
public class MetallurgicFurnaceRecipeCategory implements IRecipeCategory<MetallurgicFurnaceRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "metallurgic_furnace");
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.megalosaio.metallurgic_furnace");
    }
