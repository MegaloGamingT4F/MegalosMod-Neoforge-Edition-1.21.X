package net.megalogaminguk.megalosaio.tabs;
...
public class ModCreativeModeTabs
{
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TAB =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, MegalosAIO.MOD_ID);
    ...
    public static final Supplier<CreativeModeTab> METALLURGY_CORE_TAB = CREATIVE_MODE_TAB.register("metallurgy_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.ALUMINIUM_ORE))
                    .title(Component.translatable("creativetab.megalosaio.metallurgy_tab"))
                    .withTabsAfter(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "alloys_tab"))
    ...
    public static final Supplier<CreativeModeTab> METALLURGY_ALLOYS_TAB = CREATIVE_MODE_TAB.register("alloys_tab",
        () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.AA_INGOT.get()))
                .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "metallurgy_tab"))
                .withTabsAfter(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "hoplology_tab"))
                .title(Component.translatable("creativetab.megalosaio.alloys_tab"))
                .displayItems((itemDisplayParameters, output) -> {
                    //Block
    ...
    public static final Supplier<CreativeModeTab> HOPLOLOGY_TAB = CREATIVE_MODE_TAB.register("hoplology_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.TITANIUM_SWORD.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "alloys_tab"))
                    .withTabsAfter(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "nature_tab"))
                    .title(Component.translatable("creativetab.megalosaio.hoplology_tab"))
                    .displayItems((itemDisplayParameters, output) -> {
                        //Aluminium
    ...
    public static final Supplier<CreativeModeTab> NATURE_CROPS_TAB = CREATIVE_MODE_TAB.register("nature_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BHUT_JOLOKIA_CHILLI_SEEDS.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "hoplology_tab"))
                    .withTabsAfter(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "decorative_tab"))
    ...
    public static final Supplier<CreativeModeTab> NATURE_DECORATIVE_TAB = CREATIVE_MODE_TAB.register("decorative_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.LIGHT_PURPLE_WOOL_BLOCK.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "nature_tab"))
                    .withTabsAfter(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "technology_tab"))
                    .title(Component.translatable("creativetab.megalosaio.decorative_tab"))
                    .displayItems((itemDisplayParameters, output) -> {
                        //Wool
                        output.accept(ModBlocks.DARK_GRAY_WOOL_BLOCK.get());
                        output.accept(ModBlocks.LIGHT_BROWN_WOOL_BLOCK.get());
                        output.accept(ModBlocks.DARK_BROWN_WOOL_BLOCK.get());
                        output.accept(ModBlocks.DARK_RED_WOOL_BLOCK.get());
                        output.accept(ModBlocks.LIGHT_ORANGE_WOOL_BLOCK.get());
                        output.accept(ModBlocks.LIGHT_YELLOW_WOOL_BLOCK.get());
                        output.accept(ModBlocks.DARK_BLUE_WOOL_BLOCK.get());
                        output.accept(ModBlocks.LIGHT_GREEN_WOOL_BLOCK.get());
                        output.accept(ModBlocks.DARK_GREEN_WOOL_BLOCK.get());
                        output.accept(ModBlocks.LIGHT_PURPLE_WOOL_BLOCK.get());
    ...
    public static final Supplier<CreativeModeTab> TECHNOLOGY_TAB = CREATIVE_MODE_TAB.register("technology_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.PEDESTAL.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "decorative_tab"))
                    .withTabsAfter(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "gastronomy_tab"))
                    .title(Component.translatable("creativetab.megalosaio.technology_tab"))
                    .displayItems((itemDisplayParameters, output) -> {
                        //Tech - Block
    ...
    public static final Supplier<CreativeModeTab> GASTRONOMY_TAB = CREATIVE_MODE_TAB.register("gastronomy_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BEEF_CARCASS.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "technology_tab"))
                    .title(Component.translatable("creativetab.megalosaio.gastronomy_tab"))
                    .displayItems((itemDisplayParameters, output) -> {
                        //Beef
