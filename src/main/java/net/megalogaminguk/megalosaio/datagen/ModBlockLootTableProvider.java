...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate(){
        ...
        //Wool
        dropSelf(ModBlocks.LIGHT_BROWN_WOOL_BLOCK.get());
        dropSelf(ModBlocks.LIGHT_GREEN_WOOL_BLOCK.get());
        dropSelf(ModBlocks.LIGHT_ORANGE_WOOL_BLOCK.get());
        dropSelf(ModBlocks.LIGHT_PURPLE_WOOL_BLOCK.get());
        dropSelf(ModBlocks.LIGHT_YELLOW_WOOL_BLOCK.get());
        dropSelf(ModBlocks.DARK_BLUE_WOOL_BLOCK.get());
        dropSelf(ModBlocks.DARK_BROWN_WOOL_BLOCK.get());
        dropSelf(ModBlocks.DARK_GRAY_WOOL_BLOCK.get());
        dropSelf(ModBlocks.DARK_GREEN_WOOL_BLOCK.get());
        dropSelf(ModBlocks.DARK_RED_WOOL_BLOCK.get());
