...
import net.megalogaminguk.megalosaio.block.custom.nature.bush.GooseberryBushBlock;
import net.megalogaminguk.megalosaio.block.custom.nature.crop.chilli.*;
...
public class ModBlockStateProvider extends BlockStateProvider {
    public ModBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, MegalosAIO.MOD_ID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        //Wool
        blockWithItem(ModBlocks.LIGHT_BROWN_WOOL_BLOCK);
        blockWithItem(ModBlocks.LIGHT_GREEN_WOOL_BLOCK);
        blockWithItem(ModBlocks.LIGHT_ORANGE_WOOL_BLOCK);
        blockWithItem(ModBlocks.LIGHT_PURPLE_WOOL_BLOCK);
        blockWithItem(ModBlocks.LIGHT_YELLOW_WOOL_BLOCK);
        blockWithItem(ModBlocks.DARK_BLUE_WOOL_BLOCK);
        blockWithItem(ModBlocks.DARK_BROWN_WOOL_BLOCK);
        blockWithItem(ModBlocks.DARK_GRAY_WOOL_BLOCK);
        blockWithItem(ModBlocks.DARK_GREEN_WOOL_BLOCK);
        blockWithItem(ModBlocks.DARK_RED_WOOL_BLOCK);
        ...
        wallBlock(ModBlocks.EBONY_WALL.get(), blockTexture(ModBlocks.EBONY_PLANKS.get()));
        ...
        doorBlockWithRenderType(ModBlocks.EBONY_DOOR.get(), modLoc("block/ebony_door_bottom"),modLoc("block/ebony_door_top"),"cutout");
    ...
    private ConfiguredModel[] states(BlockState state, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().cross(modelName + state.getValue(GooseberryBushBlock.AGE),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(GooseberryBushBlock.AGE))).renderType("cutout"));
    ...
    private ConfiguredModel[] bhutStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((BhutJolokiaChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] birdsStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((BirdsEyeChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((BirdsEyeChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] carolinaStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((CarolinaReaperChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((CarolinaReaperChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] cayenneStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((CayenneChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((CayenneChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] habaneroStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((HabaneroChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((HabaneroChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] jalapenoStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((JalapenoChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((JalapenoChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] nagaGhostStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((NagaGhostChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((NagaGhostChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] padronStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((PadronChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((PadronChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] poblanoStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((PoblanoChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((PoblanoChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] scotchStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((ScotchBonnetChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((ScotchBonnetChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] silingStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((SilingLabuyoChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((SilingLabuyoChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] tabascoStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((TabascoChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((TabascoChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private ConfiguredModel[] trinidadStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((TrinidadScorpionChilliCropBlock) block).getAgeProperty()),
                ResourceLocation.fromNamespaceAndPath(MegalosAIO.MOD_ID, "block/" + textureName + state.getValue(((TrinidadScorpionChilliCropBlock) block).getAgeProperty()))).renderType("cutout"));
        return models;
    }
    ...
    private void blockItem(DeferredBlock<?> deferredBlock) {
        simpleBlockItem(deferredBlock.get(), new ModelFile.UncheckedModelFile("megalosaio:block/" + deferredBlock.getId().getPath()));
    }

    private void blockItem(DeferredBlock<?> deferredBlock, String appendix) {
        simpleBlockItem(deferredBlock.get(), new ModelFile.UncheckedModelFile("megalosaio:block/" + deferredBlock.getId().getPath() + appendix));
    }
}